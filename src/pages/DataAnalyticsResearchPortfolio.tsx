...
import { breadcrumbSchema, siteNavigationSchema } from '../lib/seoData';
...
interface Publication {
  category: 'Published Research' | 'Under Review' | 'Research in Progress';
  title: string;
  authors: string;
  journal: string;
  year: string;
...
const JSON_LD = [
  ...
  {
    '@type': 'WebPage',
    '@id': 'https://www.ronaldobal.com/data-analytics-research-portfolio#webpage',
    url: 'https://www.ronaldobal.com/data-analytics-research-portfolio',
    name: PAGE_TITLE,
    description: PAGE_DESCRIPTION,
    inLanguage: 'en-GB',
    isPartOf: { '@id': 'https://www.ronaldobal.com/#website' },
    primaryImageOfPage: { '@id': 'https://www.ronaldobal.com/#primaryimage' },
    mainEntity: { '@id': 'https://www.ronaldobal.com/data-analytics-research-portfolio#researchproject' },
  },
  {
    '@type': 'ResearchProject',
    '@id': 'https://www.ronaldobal.com/data-analytics-research-portfolio#researchproject',
  ...
  {
    '@type': 'CreativeWork',
    '@id': 'https://www.ronaldobal.com/data-analytics-research-portfolio#portfolio',
    name: 'Uganda MEAL & Data Analytics Portfolio',
    description:
      'A professional portfolio page showcasing monitoring, evaluation, accountability, learning and data analysis work in Uganda.',
    author: { '@id': 'https://www.ronaldobal.com/#person' },
    genre: 'Portfolio',
    url: 'https://www.ronaldobal.com/data-analytics-research-portfolio',
  },
  {
    ...
    '@id': 'https://www.ronaldobal.com/data-analytics-research-portfolio#article',
    headline: 'Educational Inequality in Uganda: Evidence from DHS 2024–25',
    name: 'DHS Education Data Analysis Article',
    author: { '@id': 'https://www.ronaldobal.com/#person' },
    datePublished: '2024-10-01',
    isAccessibleForFree: true,
    about: { '@id': 'https://www.ronaldobal.com/data-analytics-research-portfolio#researchproject' },
    publisher: {
      '@type': 'Organization',
      name: 'Ronald Obal Research',
      url: 'https://www.ronaldobal.com',
    },
  },
  breadcrumbSchema([
    { name: 'Home', path: '/' },
                ...
                <div key={idx}>
                  ...
                  <div className="space-y-4">
                    {catPubs.map((pub, pIdx) => (
                      <div key={pIdx} className="bg-[#f7f5f0] p-8 rounded-3xl border border-transparent hover:border-[#C9A227]/30 transition-all">
                        <div className="flex flex-wrap items-center justify-between gap-2 mb-4 text-xs uppercase tracking-[0.28em] text-[#C9A227] font-bold">
                          <span>{pub.journal}</span>
                          <span>{pub.year}</span>
                        </div>
                        <h4 className="text-xl font-semibold text-[#0A2A43] leading-snug">{pub.title}</h4>
                        <p className="mt-2 text-xs text-gray-500 font-semibold">Authors: {pub.authors}</p>
                        <p className="mt-3 text-sm text-gray-600 leading-relaxed">{pub.description}</p>
