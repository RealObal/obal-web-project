...
export default function About() {
  ...
  const education = [
    { title: 'Postgraduate Diploma in Monitoring & Evaluation', org: 'Gulu University', meta: 'Completed' },
    { title: 'Bachelor of Arts in Education (Geography & Economics)', org: 'Gulu University', meta: '' },
  ];
